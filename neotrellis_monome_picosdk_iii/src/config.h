...
#define BRIGHTNESS  112      // overall brightness (lower = dimmer; may need reduction for larger grids)
...
static const uint8_t gammaTable[16] = {0,  4,  7, 10, 15,  22,  29,  36, 
                                      45, 59, 70, 80, 92, 103, 115, 127 };
